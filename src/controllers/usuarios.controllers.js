...
export const registerController = async (req, res) => {
    ...
    const [rows] = await pool.query(`INSERT INTO user (nombre, apellido, usuario, contraseña, nivel) VALUES (?,?,?,?,?)`,
...
export const createController = async(req, res) => {
    ...
    console.log(hashpassword)
    console.log(nombre, apellido, usuario, contrasena);
    const [rows] = await pool.query(`INSERT INTO user (nombre, apellido, usuario, contraseña) VALUES (?,?,?,?)`,
    [nombre, apellido, usuario, hashpassword])
    res.send({rows})
}
...
export const updateUserController = async(req, res) => {
    ...
    const [rows] = await pool.query(`UPDATE user SET nombre = ?, apellido = ?, usuario = ?`, [nombre, apellido, usuario])
    res.send({rows})
}
